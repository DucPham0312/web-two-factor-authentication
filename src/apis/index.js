...
export const fetchUserAPI = async () => {
  ...
  // Không cần truyền userId vào trong api này khi đã triển khai JWT Access Token vì Back-end sẽ lấy được userId từ trong payload của token.
  // Two-Factor Authentication (2FA) này thì sẽ lấy userId từ localStorage và gửi vào API để lấy về thông tin mới nhất của user.
